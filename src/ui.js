export default class UI{
        ...
        <div class="card card-body">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <ul id="albumler" class= "list-group">
    ...
    writeAllAlbums(data){
        ...
        this.profileContainer.querySelector("#albumler").innerHTML = html;
    }
